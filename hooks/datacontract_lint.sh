...
#
# Runs `datacontract lint` on edits to src/{input,output}_ports/**/*.odcs.{yaml,yml}.
...
# ODCS data contracts under src/input_ports/ or src/output_ports/
case "$file_path" in
  */src/input_ports/*.odcs.yaml | */src/input_ports/*.odcs.yml | \
  */src/output_ports/*/*.odcs.yaml | */src/output_ports/*/*.odcs.yml)
